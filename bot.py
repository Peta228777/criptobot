...
async def cmd_start(message: types.Message):
    ...
    text = (
        "👋 Привет! Ты попал к команде, которая живёт заработком, а не картинками в Инсте.\n\n"
        "Мы — практики: каждый день работаем на рынке, тестируем стратегии и оставляем только то, "
        "что реально приносит результат.\n"
